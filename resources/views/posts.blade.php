        ...
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <a href="/posts/{{$post['slug']}}" class="group">
                    <h2 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white group-hover:text-blue-400">{{$post->title}}</h2>
                </a>
                ...
                <div class="flex justify-between items-center">
                    <div class="flex items-center space-x-4 group">
                        ...
                        <a href="/posts?author={{ $post->author->username }}" class="font-medium dark:text-white group-hover:text-blue-400">
                            {{$post->author->name}}
                        </a>
                    </div>
